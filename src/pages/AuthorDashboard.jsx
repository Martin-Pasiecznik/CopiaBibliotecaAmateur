          ...
          {myBooks.map(book => (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '25px' }}>
                <div style={{ width: '60px', height: '85px', backgroundColor: '#111', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 5px 15px rgba(0,0,0,0.2)' }}>
                  <img
                ...
                <div>
                  <h3 style={{ margin: '0 0 5px 0', fontFamily: "'Crimson Pro', serif", fontSize: '1.4rem', fontWeight: 600 }}>
                    {book.title}
                  </h3>
